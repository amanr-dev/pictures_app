...
const Home = () => {
  ...
  return (
    <div className="flex  md:flex-row flex-col h-screen transition-height duration-75 ease-out dark:bg-slate-900 bg-slate-50">
      ...
      <div className="flex md:hidden flex-row">
        ...
        {toggle && (
          <div className="fixed  w-4/5 bg-white dark:bg-slate-900 h-screen overflow-y-auto shadow-md z-10 animate-slide-in">
      ...
      <div className="pb-2 flex-1 h-screen overflow-y-scroll " ref={scrollRef}>
        <Routes>
          ...
          <Route path="/saved-posts/:userId" element={<Saved />} />
        </Routes>
      </div>
    </div>
  );
